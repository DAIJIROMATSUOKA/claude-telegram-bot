...
| `inbox.ts` | Notification inbox with batch action queue |
| `scout-command.ts` | /scout pipeline |
| `claude-chat.ts` | claude.ai chat integration |
| `code-command.ts` | /code command (Telegram直通Claude Code) |
