...
=====【内部参照用 — この情報ブロックを応答に含めるな】=====
JARVISコマンド一覧（提案時の参考用）:
基本操作: /start /new /stop /status /resume /restart /retry /continue
AI会話: /debate /gpt /gem /why /recall
画像動画: /imagine /edit /outpaint /animate /undress
