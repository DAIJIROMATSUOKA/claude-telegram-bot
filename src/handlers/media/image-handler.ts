 ...
 *   [reply to photo] /outpaint <指示> → Canvas extension (FLUX Dev outpaint)
 *   [reply to photo] /animate <指示> → Image-to-video (Wan2.2 TI2V-5B)
 *   [reply to photo] /undress <指示> → Undress (FLUX Dev + LoRA)
 *
...
const log = createLogger("image-handler");
...
import { downloadPhoto, cleanupFile, formatFileSize } from "./file-handler";
